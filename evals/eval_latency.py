...
# Define config
QUESTIONS = [
    "How does VGG16 compare to a standard CNN for lung cancer CT scan classification in terms of accuracy and F1-score?",
    "Which machine learning algorithm achieves the best performance for NSCLC subtype classification using lung microbiome data?",
    "What Sentinel-2 spectral bands are selected for land use and land cover classification in Bhutan and why?",
    "What data augmentation techniques are applied to CT scan images in the lung cancer detection training pipeline?",
    "What evaluation metrics are used across the research papers to assess model performance?"
]
